...
function livingtmw_render_living_tools(): void {
	...
	<section class="livingtmw-tools" aria-labelledby="livingtmw-tools-title">
		<style id="livingtmw-home-width-inline">body.home #page.site,body.blog #page.site,body.home .site-content,body.blog .site-content,body.home .content-area,body.blog .content-area{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;max-width:none!important;padding-left:0!important;padding-right:0!important;width:100%!important}body.home .site-content,body.blog .site-content{padding-top:0!important}.livingtmw-tools{box-sizing:border-box;max-width:none!important;width:100%!important}</style>
...
function livingtmw_render_interior_chrome(): void {
	...
	?>
	<style id="livingtmw-interior-chrome-inline">body:not(.home):not(.blog) header#masthead,body:not(.home):not(.blog) .site-header,body:not(.home):not(.blog) nav#site-navigation,body:not(.home):not(.blog) .main-navigation,body:not(.home):not(.blog) .site-branding,body:not(.home):not(.blog) .site-logo{display:none!important}.livingtmw-shared-chrome{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;max-width:none!important;padding:28px 20px 0!important;width:100%!important}@media(max-width:768px){.livingtmw-shared-chrome{padding:28px 12px 0!important}}</style>
	<style id="livingtmw-interior-width-inline">body:not(.home):not(.blog) #page.site,body:not(.home):not(.blog) .site-content{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;max-width:none!important;width:100%!important}body:not(.home):not(.blog) .site-content{padding-left:20px!important;padding-right:20px!important}@media(max-width:768px){body:not(.home):not(.blog) .site-content{padding-left:12px!important;padding-right:12px!important}}</style>
