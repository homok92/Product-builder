...
function livingtmw_render_living_tools(): void {
	...
	<section class="livingtmw-tools" aria-labelledby="livingtmw-tools-title">
		<style id="livingtmw-home-width-inline">body.home #page.site,body.blog #page.site,body.home .site-content,body.blog .site-content,body.home .content-area,body.blog .content-area{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;max-width:none!important;padding-left:0!important;padding-right:0!important;width:100%!important}.livingtmw-tools{box-sizing:border-box;max-width:none!important;width:100%!important}</style>
...
function livingtmw_render_interior_chrome(): void {
	...
	<style id="livingtmw-interior-width-inline">body:not(.home):not(.blog) #page.site{box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important;max-width:1240px!important;width:100%!important}body:not(.home):not(.blog) .site-content{box-sizing:border-box!important;max-width:1240px!important;padding-left:20px!important;padding-right:20px!important;width:100%!important}@media(max-width:768px){body:not(.home):not(.blog) .site-content{padding-left:12px!important;padding-right:12px!important}}</style>
