...
function livingtmw_render_living_tools(): void {
	...
	<section class="livingtmw-tools" aria-labelledby="livingtmw-tools-title">
		<style id="livingtmw-home-width-inline">body.home #page.site,body.blog #page.site,body.home .site-content,body.blog .site-content,body.home .content-area,body.blog .content-area{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;margin-top:0!important;max-width:none!important;padding-left:0!important;padding-right:0!important;width:100%!important}body.home .site-content,body.blog .site-content{padding-top:0!important}.livingtmw-tools{box-sizing:border-box;max-width:none!important;margin-top:0!important;padding-top:28px!important;width:100%!important}</style>
...
function livingtmw_render_interior_chrome(): void {
	...
	<style id="livingtmw-interior-width-inline">body:not(.home):not(.blog) #page.site,body:not(.home):not(.blog) .site-content{box-sizing:border-box!important;margin-left:0!important;margin-right:0!important;max-width:none!important;width:100%!important}body:not(.home):not(.blog) .site-content{display:grid!important;gap:14px!important;grid-template-columns:minmax(0,2.32fr) minmax(300px,.68fr)!important;padding-left:20px!important;padding-right:20px!important}body:not(.home):not(.blog) .content-area,body:not(.home):not(.blog) .widget-area{box-sizing:border-box!important;margin:0!important;min-width:0!important;padding-left:0!important;padding-right:0!important;width:auto!important}body:not(.home):not(.blog) .content-area{grid-column:1!important}body:not(.home):not(.blog) .widget-area{grid-column:2!important}body:not(.home):not(.blog) .inside-right-sidebar{margin:0!important}@media(max-width:860px){body:not(.home):not(.blog) .site-content{grid-template-columns:1fr!important}body:not(.home):not(.blog) .content-area,body:not(.home):not(.blog) .widget-area{grid-column:1!important}}@media(max-width:768px){body:not(.home):not(.blog) .site-content{padding-left:12px!important;padding-right:12px!important}}</style>
	<style id="livingtmw-interior-alert-inline">.livingtmw-shared-chrome>.livingtmw-home-alert{background:linear-gradient(90deg,color-mix(in srgb,var(--livingtmw-dashboard-gold) 14%,var(--livingtmw-dashboard-card)),color-mix(in srgb,var(--livingtmw-dashboard-gold) 23%,var(--livingtmw-dashboard-card)),color-mix(in srgb,var(--livingtmw-dashboard-gold) 14%,var(--livingtmw-dashboard-card)));border-color:color-mix(in srgb,var(--livingtmw-dashboard-gold) 46%,var(--livingtmw-dashboard-line));border-radius:9px;box-sizing:border-box;grid-column:1/-1;grid-row:1;justify-content:center;margin:0 0 -8px;min-height:34px;padding:5px 12px;text-align:center}.livingtmw-shared-chrome>.livingtmw-home-alert strong{padding:3px 8px}.livingtmw-shared-chrome>.livingtmw-home-alert>span{margin-left:10px}.livingtmw-shared-chrome>.livingtmw-home-menu{grid-column:1/-1;grid-row:2}html[data-theme="dark"] .livingtmw-shared-chrome>.livingtmw-home-alert{background:linear-gradient(90deg,#211a0d,#38290c,#211a0d);border-color:#71551b}@media(max-width:560px){.livingtmw-shared-chrome>.livingtmw-home-alert{flex-wrap:nowrap;font-size:11px;justify-content:flex-start;overflow:hidden;white-space:nowrap}.livingtmw-shared-chrome>.livingtmw-home-alert strong{font-size:9px}.livingtmw-shared-chrome>.livingtmw-home-alert>span{display:none}}</style>
