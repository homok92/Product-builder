...
function livingtmw_render_interior_chrome(): void {
	...
	<style id="livingtmw-interior-width-inline">body:not(.home):not(.blog) #page.site{box-sizing:border-box!important;margin-left:auto!important;margin-right:auto!important;max-width:1240px!important;width:100%!important}.livingtmw-shared-chrome,body:not(.home):not(.blog) .site-content{box-sizing:border-box!important;max-width:1240px!important;padding-left:20px!important;padding-right:20px!important;width:100%!important}@media(max-width:768px){.livingtmw-shared-chrome,body:not(.home):not(.blog) .site-content{padding-left:12px!important;padding-right:12px!important}}</style>
