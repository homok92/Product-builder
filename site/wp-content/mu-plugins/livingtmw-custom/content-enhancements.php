...
function livingtmw_upcoming_article_deep_dive( int $post_id ): string {
	$sections = array(
		37 => '<section class="livingtmw-deep-dive"><h2>우기 출근 계획은 전날부터 준비합니다</h2><p>비 예보가 있으면 평소 경로 하나만 믿지 말고 고가도로와 큰 도로를 중심으로 대체 경로를 저장하세요. 회사와 학교에는 침수 시 연락할 담당자와 재택·지각 처리 방법을 미리 확인합니다. 출발 직전에는 지도 앱뿐 아니라 거주지 관리실, 동료와 운전기사에게 실제 도로 상태를 물어보는 편이 정확합니다.</p><div class="livingtmw-checklist"><h3>우기 이동 가방</h3><ul><li>충전된 보조배터리와 방수 주머니</li><li>식수, 복용약과 간단한 간식</li><li>우산·얇은 우의와 여분 양말</li><li>보험·회사·가족의 비상 연락처</li></ul></div><p>차량 바닥까지 물이 올라오거나 수심을 알 수 없다면 진입하지 마세요. 침수 뒤에는 브레이크와 전기장치를 점검하고, 집에 돌아온 뒤 젖은 신발과 옷은 바로 세척·건조합니다. 일정 지연보다 사람과 차량의 안전을 우선하는 기준을 가족과 공유해 두는 것이 중요합니다.</p><h2>출발 여부는 세 단계로 판단했습니다</h2><div class="livingtmw-table-wrap"><table><thead><tr><th>확인 결과</th><th>우리 가족의 대응</th></tr></thead><tbody><tr><td>도로가 정상이고 비가 약함</td><td>평소보다 일찍 출발하고 귀가 경로를 다시 확인</td></tr><tr><td>일부 구간 침수·정체</td><td>큰 도로의 대체 경로를 확인한 뒤 회사와 출발 시각 조정</td></tr><tr><td>수심을 모르거나 차량 통제가 시작됨</td><td>이동을 중단하고 회사·학교에 즉시 상황 공유</td></tr></tbody></table></div><p>한 번 통과했던 길도 비가 이어지면 수위와 노면 상태가 달라질 수 있습니다. 지도 앱의 예상 시간만으로 안전을 판단하지 않고, 관리실과 현지 운전기사에게 같은 구간을 교차 확인했습니다. 정전이 함께 발생할 가능성에 대비해 출발 전 휴대전화와 보조배터리를 충전하고 가족에게 목적지와 예상 귀가 시간을 남겼습니다.</p></section>',
