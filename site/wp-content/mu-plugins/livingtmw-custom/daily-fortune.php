...
function livingtmw_render_daily_fortune(): string {
	...
	$zodiac_faq           = 'my' === $language ? 'ကံကြမ္မာတွက်ချက်ရာတွင် တိရစ္ဆာန်နှစ်ကို ရွေးပါက မွေးသက္ကရာဇ်မလိုပါ။' : '네. 운세 기준에서 ‘띠 선택’을 고르면 생년월일 없이 이용할 수 있습니다.';
	ob_start();
	?>
	<section class="livingtmw-fortune" data-daily-fortune data-language="<?php echo esc_attr( $language ); ?>">
		...
		<section class="livingtmw-fortune__faq">
			<h2>자주 묻는 질문</h2>
			<details><summary>생년월일을 입력하지 않아도 되나요?</summary><p><?php echo esc_html( $zodiac_faq ); ?></p></details>
...
function livingtmw_fortune_mobile_choice_layout(): void {
	...
	echo '<style id="livingtmw-fortune-mobile-choice-layout">@media (max-width:760px){.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings>.livingtmw-fortune__setting-row,.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings>.livingtmw-fortune__setting-row+ .livingtmw-fortune__setting-row{display:block!important;border:0!important;padding:0!important}.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings>.livingtmw-fortune__setting-row+ .livingtmw-fortune__setting-row{border-top:1px solid var(--livingtmw-border)!important;margin-top:8px!important;padding-top:8px!important}.livingtmw-fortune[data-language="my"] .livingtmw-fortune__setting-label{display:block!important;margin:0 0 6px!important;width:100%!important}.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings .livingtmw-fortune__choices{display:flex!important;flex-direction:row!important;gap:8px!important;grid-template-columns:none!important;width:100%!important;max-width:none!important;margin:0!important}.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings .livingtmw-fortune__choices>label{flex:1 1 0!important;width:50%!important;min-width:0!important}.livingtmw-fortune[data-language="my"] .livingtmw-fortune__settings .livingtmw-fortune__choices>label>span{display:block!important;width:100%!important;text-align:center!important}}</style>';
}
