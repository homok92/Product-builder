...
add_action( 'template_redirect', static function (): void {
	...
	ob_start( static function ( string $html ) use ( $rates ): string {
		...
		$card = sprintf(
			'<article class="livingtmw-market-rate livingtmw-market-rate--official"><div class="livingtmw-tool-card__heading"><div><p class="livingtmw-tool-card__kicker">CB Bank 공식 고시</p><h3>USD · EUR 환율</h3></div><span class="livingtmw-market-rate__icon" aria-hidden="true">💱</span></div><div class="livingtmw-market-rate__grid"><div><strong>1 USD</strong><span>매입 %s MMK</span><span>매도 %s MMK</span></div><div><strong>1 EUR</strong><span>매입 %s MMK</span><span>매도 %s MMK</span></div></div><p class="livingtmw-tool-card__meta">Exchange Counter Rate%s%s · 실제 거래 전 은행 고시를 다시 확인하세요. <a href="https://www.cbbank.com.mm/en" target="_blank" rel="noopener noreferrer">CB Bank 공식 페이지</a></p></article>',
