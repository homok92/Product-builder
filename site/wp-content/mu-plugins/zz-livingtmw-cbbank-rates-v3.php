...
add_action( 'template_redirect', static function (): void {
	...
	ob_start( static function ( string $html ) use ( $rates ): string {
		...
		$card = sprintf(
			'<article class="livingtmw-market-rate" aria-label="오늘의 은행환율"><div class="livingtmw-tool-card__heading"><div><p class="livingtmw-tool-card__kicker">CB Bank 공식 고시</p><h3>오늘의 은행환율</h3></div><span class="livingtmw-market-rate__icon" aria-hidden="true">💱</span></div><div class="livingtmw-market-rate__rows"><div><strong>1 USD</strong><span><small>BUY</small><b>%s</b><em>MMK</em></span><span><small>SELL</small><b>%s</b><em>MMK</em></span></div><div><strong>1 EUR</strong><span><small>BUY</small><b>%s</b><em>MMK</em></span><span><small>SELL</small><b>%s</b><em>MMK</em></span></div></div><p>Exchange Counter Rate%s%s · 실제 거래 전 은행 고시를 다시 확인하세요. <a href="https://www.cbbank.com.mm/en" target="_blank" rel="noopener noreferrer">CB Bank 공식 페이지</a></p></article>',
